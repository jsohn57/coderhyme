...
try{
	nCasperSports.start("http://news.nate.com/rank/interest?sc=soc");
	...
	nCasperSports.run(function() {
		...
		var i, il;
		var fs = require('fs');	
		if(fs.exists("/projects/GiantEagle/webcrawler/dat/nate/soc/article_url.in")){
			fs.remove("/projects/GiantEagle/webcrawler/dat/nate/soc/article_url.in");
		}	
		if(fs.exists("/projects/GiantEagle/webcrawler/dat/nate/soc/reply_url.in")){
			fs.remove("/projects/GiantEagle/webcrawler/dat/nate/soc/reply_url.in");
		}
		if(fs.exists("/projects/GiantEagle/webcrawler/dat/nate/soc/title.in")){
			fs.remove("/projects/GiantEagle/webcrawler/dat/nate/soc/title.in");
		}	

		var articleStream = fs.open("/projects/GiantEagle/webcrawler/dat/nate/soc/article_url.in", 'w');
		var replyStream = fs.open("/projects/GiantEagle/webcrawler/dat/nate/soc/reply_url.in", 'w');
		var titleStream = fs.open("/projects/GiantEagle/webcrawler/dat/nate/soc/title.in", 'w');	
