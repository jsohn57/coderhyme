...
try{
	nCasperSports.start("http://news.nate.com/rank/interest?sc=eco");
	...
	nCasperSports.run(function() {
		...
		var i, il;
		var fs = require('fs');	
		if(fs.exists("/projects/GiantEagle/webcrawler/dat/nate/eco/article_url.in")){
			fs.remove("/projects/GiantEagle/webcrawler/dat/nate/eco/article_url.in");
		}	
		if(fs.exists("/projects/GiantEagle/webcrawler/dat/nate/eco/reply_url.in")){
			fs.remove("/projects/GiantEagle/webcrawler/dat/nate/eco/reply_url.in");
		}
		if(fs.exists("/projects/GiantEagle/webcrawler/dat/nate/eco/title.in")){
			fs.remove("/projects/GiantEagle/webcrawler/dat/nate/eco/title.in");
		}	

		var articleStream = fs.open("/projects/GiantEagle/webcrawler/dat/nate/eco/article_url.in", 'w');
		var replyStream = fs.open("/projects/GiantEagle/webcrawler/dat/nate/eco/reply_url.in", 'w');
		var titleStream = fs.open("/projects/GiantEagle/webcrawler/dat/nate/eco/title.in", 'w');	
